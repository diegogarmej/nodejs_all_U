...
import { DoctorCreationError,  PatientGetAllError,  RecordNotFoundError,PatientUpdateError,PatientDeleteError } from "../../../config/customErrors"
...
export class PatientRepository {
    ...
    public async updatePaciente(id: number, updates: Partial<PatientReq>): Promise<void> {
        try{
